...
public class AdTrackingDeserializationSchema implements DeserializationSchema<AdTracking> {
    ...
    public AdTracking deserialize(byte[] bytes) {
        try {
            ...
            String salaryUnit = getStringValue("unit", salaryNode);
            Long salaryMin = getLongValue("min", msgNode);
            Long salaryMax = getLongValue("max", msgNode);
            String jobLabel = getStringValue("jobLabel", msgNode);
            String signalLabel = getStringValue("signalLabel", msgNode);
            ...
            String requestUrl = getStringValue("notKeyword", msgNode);
            ...
            AdTracking a = AdTracking
                    ...
                    .build();
            LOG.info("Builded node: {}", a.toString());
            return AdTracking
                    .newBuilder()
                    .setLogType(logType)
                    .setDistributionId(distributionId)
